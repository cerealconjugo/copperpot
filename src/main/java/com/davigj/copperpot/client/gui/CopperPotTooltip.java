...
public class CopperPotTooltip implements ClientTooltipComponent
{
   ...
   public CopperPotTooltip(CopperPotTooltipComponent tooltip) {
   ...
   public static record CopperPotTooltipComponent(ItemStack mealStack) implements TooltipComponent
   {
   }
}