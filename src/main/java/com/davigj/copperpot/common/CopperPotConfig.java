...
public class CopperPotConfig {
   ...
   public static class Common {
      ...
      public final ForgeConfigSpec.ConfigValue<List<String>> autumnalExtensionFx;
      public final ForgeConfigSpec.ConfigValue<List<String>> aestivalExtensionFx;
      public final ForgeConfigSpec.ConfigValue<List<String>> brumalExtensionFx;
      public final ForgeConfigSpec.ConfigValue<List<String>> vernalExtensionFx;
      ...
      Common(ForgeConfigSpec.Builder builder) {
         ...
         autumnalExtensionFx = builder.comment("A list of effects which will be extended upon consumption of autumnal agar.")
                 .define("autumnalExtensionFx", Lists.newArrayList("effect.minecraft.resistance",
                         "effect.farmersdelight.nourishment", "effect.minecraft.absorption", "effect.atmospheric.persistence"));
